...
export RPC_SERVER_URL="https://api.shardeum.org"
...
export NEXT_PUBLIC_RPC_URL="https://api.shardeum.org"
export NEXT_PUBLIC_EXPLORER_URL="https://explorer.shardeum.org"
