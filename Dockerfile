...
ARG RPC_SERVER_URL="https://api-testnet.shardeum.org"
...
ARG NEXT_PUBLIC_RPC_URL="https://api-testnet.shardeum.org"
ARG NEXT_PUBLIC_EXPLORER_URL="https://explorer-testnet.shardeum.org"
ARG SHMEXT=9001
ARG SHMINT=10001
ARG DASHPORT=8080
ARG RUNDASHBOARD="y"
